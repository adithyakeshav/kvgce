    ...
    <div class="row">
        ...
        <div class="col-xs-4"  style="background-color:white"> 
            ...
            <form method="POST">
                <br>
                <div align="center">
                  <img src="mages/avatar.png" class="avatar">
                </div>
                ...
                <div style="padding:20px">
                    ...
                    <input type="password" placeholder="Enter Password" name="newpasswd" required class="form-control"> <br>

                    <label class="lead"><b>Secret Key</b></label> <br>
                    <input type="password" placeholder="Enter Secret Key" name="secretkey" required class="form-control"> <br>

                    <p class="lead text-danger">
                        <?php
                        if(isset($_GET['fail']) )
                            echo "Unable to Sign Up..!! Username may already Exist";
                        if(isset($_GET['invalid']))
                            echo "Invalid Secret Key..!! Try with Valid Secret Key";
                        ?>
                    </p>

                    <button type="submit" class="btn btn-primary form-control" name="submit">Register</button> <br> <br>
